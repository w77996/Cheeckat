...
public class Log {
	...
	@Pointcut("@annotation(com.award.core.annotation.po.Log)")
		...
		for (Method method : methods) {
			if (method.getName().equals(name)) {
				...
				if (clazzs.length == arguments.length) {
					...
					methodName = method.getAnnotation(com.award.core.annotation.Log.class).action();
