<%@ page language="java" pageEncoding="UTF-8" import="java.util.*,com.award.sy.entity.*"%>
<%
	Admin user = (Admin)session.getAttribute("currentUser"); //登录用户
	if(user == null){
%>
...
<header class="main-header">
	...
	<a href="<%=path%>" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini">管理</span> <!-- logo for regular state and mobile devices -->
			...
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
						...
						<span class="hidden-xs">${currentUser.username}</span>, <sp:message code="sys.wel"/>
					</a>
