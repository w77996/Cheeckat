	...
	<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="row-fluid">
						...
						<div class="row">
							<form id="queryForm" action="<%=path%>/order/list" method="post">
								<div class="col-xs-2">
									...
									<table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" align="center">
										<thead>
											<tr class="info">
											  ...
											  <th><sp:message code="order.number"/></th>
											  <th><sp:message code="order.money"/></th>
												<th><sp:message code="order.code"/></th>
	    ...
	    　　　　　　　　	//$('td', row).eq(5).css('font-weight',"bold").css("color","red");//获取到具体行具体格的元素
				...
				$('#dataTable tbody').on( 'click', '#editRow', function () {
					...
					$("input[name=user_name]").val(data.group_name);
					$("input[name=device_id]").val(data.rake_back);
				...
				$('#dataTable tbody').on( 'click', '#delRow', function () {
		            ...
		            if(confirm("是否确认删除这条信息?")){
		                $.ajax({
		                    url:'<%=path%>/device/del/'+data.companyIdStr,
		                    type:'delete',
		                    dataType: "json",
		                    //timeout:"3000",
		                    cache:"false",
