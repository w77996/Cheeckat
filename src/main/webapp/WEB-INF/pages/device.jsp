	...
	<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="row-fluid">
						...
						<div class="row">
							<form id="queryForm" action="<%=path%>/device/list" method="post">
								<div class="col-xs-2">
									...
									<table id="dataTable" class="table table-striped table-bordered table-hover table-condensed" align="center">
										<thead>
											<tr class="info">
												...
												<th><sp:message code="device.id"/></th>
												<th><sp:message code="device.name"/></th>
			...
			<div class="modal-dialog" >
				<div class="modal-content">
					...
					<div class="modal-body" >
						<form class="form-horizontal"  id="editForm" action="<%=path%>/device/update" method="post">
							<input type="hidden" class="form-control" name="deviceId">
							<div class="form-group">
								<label for="inputName" class="col-sm-3 control-label"><sp:message code="device.name"/></label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="user_name">
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail" class="col-sm-3 control-label"><sp:message code="device.id"/></label>
								<div class="col-sm-9">
				...
				var result = "${result}";
		  		...
		  		var tables = $("#dataTable").dataTable({
			        ...
			        ajax: {   //类似jquery的ajax参数，基本都可以用。
			            ...
			            url: "<%=path%>/device/getData/"+groupId,
	                ...
	                columns: [//对应上面thead里面的序列
	                    ...
	                    {"data": null},
	               		{"data": 'device_id'}, //mData 表示发请求时候本列的列明，返回的数据中相同下标名字的数据会填充到这一列
	               		{"data": 'user_name'},
	               		{"data": 'create_time', 
	                ...
	                columnDefs: [
		                ...
		                },*/
		                {
		                    ...
		                    defaultContent: " <div class='btn-group'>"+
		                    				...
		                    				"<button id='configRow' class='btn btn-primary btn-sm' type='button'><i class='fa fa-cog'></i></button>"+
	    ...
	    　　　　　　　　	//$('td', row).eq(5).css('font-weight',"bold").css("color","red");//获取到具体行具体格的元素
	            ...
	            $("#btn-add").on("click", function () {
	            	url = "<%=path%>/device/add/"+groupId;
					$("input[name=deviceId]").val(0);
				...
				$('#dataTable tbody').on( 'click', '#editRow', function () {
					...
					$("input[name=deviceId]").val(data.deviceIdStr);
				...
				$('#dataTable tbody').on( 'click', '#delRow', function () {
		            ...
		            if(confirm("是否确认删除这条信息?")){
		                $.ajax({
		                    url:'<%=path%>/device/del/'+data.deviceIdStr,
		                    type:'delete',
		                    dataType: "json",
		                    //timeout:"3000",
		                    cache:"false",
				...
				$('#dataTable tbody').on( 'click', '#configRow', function () {
					...
					location.href='<%=path%>/order/list/'+data.deviceIdStr;
		        });
			});
		</script>
